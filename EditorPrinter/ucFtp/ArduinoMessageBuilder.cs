                ...
                if ( getMode() == (int)modes.HEADER_MODE ) {
                    ...
                    if(headerBuilder.isComplete() ) {
                        ...
                        if(i == 0) {
                            ...
                            System.Diagnostics.Debug.WriteLine("ArduinoMessageBuilder.cs: Unhandled case 1");
                        } 
                    }
                ...
                if ( getMode() == (int)modes.PAYLOAD_MODE ) {
                    ...
                    if(payloadBuilder.isComplete() ) {
                        if(i == 0) {
                            ...
                            System.Diagnostics.Debug.WriteLine("ArduinoMessageBuilder.cs: Unhandled case 2");
                        } 
                    }
                } 
                ...
                if ( getMode() == (int)modes.FOOTER_MODE ) {
                    ...
                    if(footerBuilder.isComplete() ) {
                        if(i == 0) {
                            ...
                            System.Diagnostics.Debug.WriteLine("ArduinoMessageBuilder.cs: Unhandled case 3");
                        } 
                    }
                } 
