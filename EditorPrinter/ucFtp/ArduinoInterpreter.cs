    ...
    class HeaderLineProccessor : ArduinoLineProccesor {
        ...
        public static int valid(string line, ProccessorObjectResult por) {
            ...
            if (line.StartsWith(""+ArduinoInterpreter.START_SYMBOL)) {
                ...
                if ( msgs.Length != 3 ){
                    System.Diagnostics.Debug.WriteLine("Header proccessor: Line starts with # but do not succeed with three arguments [help: documentation].");
        ...
        public static int valid(string line, ProccessorObjectResult por) {
              ...
              if (line.Equals(ArduinoInterpreter.END_SYMBOL)) {                    
                    ...
                    if (cObjResult1 != null ){
                        ...
                        System.Diagnostics.Debug.WriteLine("ArduinoInterpreter: Unhandled case 1.");
                        return -1;
                    }
    ...
    class ArduinoInterpreter {
        ...
        public CommandObject proccess(ResultMessageBuilder sb) {
            ...
            while ( (line = pBuilder.getNextLine()) != null) {
                ...
                if ( por.get() == null ){
                    System.Diagnostics.Debug.WriteLine("ArduinoInterpreter: Unhandled case 2.");
                    break;
                }
