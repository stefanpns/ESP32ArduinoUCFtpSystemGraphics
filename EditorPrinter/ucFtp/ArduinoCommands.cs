...
namespace coreapp
{
    ...
    abstract class CommandObject {
        ...
        public virtual void print(){
            ...
            EditorPrinter.WriteLine( commandName + "/command:");
        }
     ...
     class CommentCommandObject : CommandObject {
        ...
        public override bool proccess(string line) {
            //EditorPrinter.WriteLine("dodat: " + line);
            lines.Add(line);
            return true;
        }
        public override void print(){
          base.print();
          EditorPrinter.WriteLine("Meta: " + filePath );
    ...
    class DirCommandObject : CommandObject {
       ...
       public override void print(){
        ...
        EditorPrinter.WriteLine("Count: " + lines[lines.Count-1]);
    ...
    class HelpCommandObject : CommandObject {
     ...
     class ErrorCommandObject : CommandObject {
        ...
        public override void print(){
          base.print();
            ...
            EditorPrinter.WriteLine("Execution error");
     ...
     class MdCommandObject : CommandObject {
        ...
        public override void print(){
          base.print();
           EditorPrinter.WriteLine("Folder \\" + filePath + " has been made");
        }
    }
    ...
    class CdCommandObject : CommandObject {
        ...
        public override void print(){
          base.print();
          EditorPrinter.WriteLine("Current working directory now is: " + base.filePath);
        }
    }
    ...
    class PutCommandObject : CommandObject {
        ...
        public override void print(){
          base.print();
          EditorPrinter.Write("In the file " + filePath + " have been written " + writtenBytes + " bytes.");
         }
    }
    ...
    class GetCommandObject : CommandObject {
        ...
        public GetCommandObject(string filePath, bool withCrc, string name):base(name, filePath){
            ...
            //EditorPrinter.WriteLine("filePath: " + filePath);
        ...
        public override void print(){
          base.print();
            ...
            EditorPrinter.WriteLine("File: " + this.filePath + "");
            EditorPrinter.WriteLine("Segment: [" + this.from + ", " + (this.from + this.len-1) + "]");
            if ( isWithCrc ) {
                EditorPrinter.WriteLine("CRC16 of the segment: " + data[data.Count-1]);
            }
            ...
            for ( ; i < rB; i++ ) {
                ...
                EditorPrinter.Write((char)data[i]);
                if ( ( (char)data[i]) == '\n'  ) {
                    CommandObject.WriteIndent();
                }
            }
        ...
        public override bool checkChainCmdResult(CommandObject cmdObject) {
            ...
            try {
                ...
                EditorPrinter.WriteLine(e.Message);
                return false;
            }
    ...
    class DelCommandObject : CommandObject {
        ...
        public override void print(){
          base.print();
           EditorPrinter.WriteLine("File: " + filePath + " has been erased.");
    ...
    class CrcCommandObject : CommandObject {
        ...
        public override void print(){
          base.print();
            ...
            EditorPrinter.WriteLine("File: " + this.filePath + "");
            EditorPrinter.WriteLine("Segment: [" + this.from + ", " + (this.from + this.len-1) + "]");
            EditorPrinter.Write("Crc: ");
           if ( this.crcArg == 0 || this.crcArg == 1 ) {
                EditorPrinter.WriteLine((this.crcArg == 1 ? "" : "not ")  +"valid");
            } else 
                EditorPrinter.WriteLine(""+this.crcArg);
